...
Adhearsion::Configuration.configure do |config|
  ...
  config.asterisk.enable_ami :host => "sip-server", :username => "ahn-user", :password => "ahn-pass", :events => true

  # config.enable_drb
  config.enable_drb :host => "0.0.0.0", :deny => "0.0.0.0", :allow => ["127.0.0.1", "192.168.1.1"]
